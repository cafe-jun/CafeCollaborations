...
import { CreateUserRequestDto } from '@presentation/rest-doc/user/create-user-request.dto';

export class CreateUserService implements CreateUserUseCase {
  constructor(private readonly userRepository: UserRepositoryPort) {}
  public async execute(payload: CreateUserRequestDto): Promise<UserUseCaseDto> {
