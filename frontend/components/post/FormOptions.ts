const regionFormOptions: { label: string; value: string }[] = [
...
const recruitMemberFormOptions: { label: string; value: string }[] = [
...
const durationTypeFormOptions: { label: string; value: string }[] = [
...
const categoryFormOptions: { label: string; value: string }[] = [
